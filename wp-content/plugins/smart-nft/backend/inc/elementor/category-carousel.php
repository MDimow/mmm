...
class SMARTNFT_CATEGORY_CAROUSEL extends \Elementor\Widget_Base 
{
	public function get_name() {
		return 'smartnft_category_carousel';
	}

	public function get_title() {
		return esc_html__( 'Category carousel', WP_SMART_NFT );
	}
	...
	function get_collections ($limit) {
            ...
            foreach( $terms as $term ){
				...
				$term_meta["permalink"] = get_term_link($term_id, "smartnft_category");
				$term_meta["name"] = $term->name;
			...
			<div class="collection-card">
				<a href="<?php echo $collection['permalink']; ?>">
					<figure
						...
						style="background-image: url(<?php echo $collection['cover_image'][0]; ?>)"
					></figure>
				</a>
				<a href="<?php echo $collection['permalink']; ?>">
					<div>
						<div class="collection-card__head">
							<?php if( !empty ( $collection['profile_image'][0] ) ): ?>
								<img
									class="collection-card__collection-photo"
									src="<?php echo $collection['profile_image'][0]; ?>"
								/>
							<?php else: ?>
						...
						<div class="collection-card__info">
							<div class="items">
								...
								<p class="collection-card__info__value"><?php echo $collection["count"]; ?></p>
							</div>
						</div>
					</div>
				</a>
        ...
        <?php else: ?>
            ...
            <a href="<?php echo $collection['permalink']; ?>">
                <div class="collection-grid-classic">
                        <?php if( !empty ( $collection['profile_image'][0] ) ): ?>
                            <img class="profile" src="<?php echo   $collection['profile_image'][0];?>" alt="<?php echo $collection['name']; ?>">
                        <?php else: ?>
      ...
      <script>
		(()=>{
			...
			if(typeof elementor !== "undefined"){
				elementor.hooks.addAction( 'panel/open_editor/widget/smartnft_category_carousel', function() {
					initSlider();
				});
			}
