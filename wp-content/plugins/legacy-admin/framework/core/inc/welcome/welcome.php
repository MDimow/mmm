<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/legacy_framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">5 star</a> rating. A huge thank you from Redux in advance!';
        }
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = __( "Support hash could not be generated. Please try again later.", 'legacy_framework' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            add_management_page(
                __( 'Welcome to Redux Framework', 'legacy_framework' ), __( 'Redux Framework', 'legacy_framework' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            add_management_page(
                __( 'Redux Framework Changelog', 'legacy_framework' ), __( 'Redux Framework Changelog', 'legacy_framework' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Get Support', 'legacy_framework' ), __( 'Get Support', 'legacy_framework' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Redux Extensions', 'legacy_framework' ), __( 'Redux Extensions', 'legacy_framework' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            add_management_page(
                __( 'The people that develop Redux Framework', 'legacy_framework' ), __( 'The people that develop Redux Framework', 'legacy_framework' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            add_management_page(
                __( 'Redux Framework Status', 'legacy_framework' ), __( 'Redux Framework Status', 'legacy_framework' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-about' ), 'tools.php' ) ) ); ?>">
                    <?php _e( "What's New", 'legacy_framework' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-extensions' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-extensions' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Extensions', 'legacy_framework' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-changelog' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-changelog' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Changelog', 'legacy_framework' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-credits' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-credits' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Credits', 'legacy_framework' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-support' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-support' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Support', 'legacy_framework' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-status' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-status' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Status', 'legacy_framework' ); ?>
                </a>
            </h2>
        <?php
        }
        ...
        public function parse_readme() {
            ...
            return '<script src="http://gist-it.appspot.com/https://github.com/reduxframework/legacy_framework/blob/master/CHANGELOG.md?slice=2:0&footer=0">// <![CDATA[// ]]></script>';
        ...
        public function actions() {
            ...
            <p class="redux-actions">
                ...
                <a href="https://wordpress.org/plugins/legacy_framework/" class="review-us button button-primary"
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'legacy_framework' ), $contributor->login ) )
                );
        ...
        public function get_contributors() {
            ...
            $response = wp_remote_get( 'https://api.github.com/repos/ReduxFramework/legacy_framework/contributors', array( 'sslverify' => false ) );
