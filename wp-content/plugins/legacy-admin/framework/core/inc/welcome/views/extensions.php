...
<div class="wrap about-wrap">
    <h1><?php _e( 'Redux Framework - Extensions', 'legacy_framework' ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'Supercharge your Redux experience. Our extensions provide you with features that will take your products to the next level.', 'legacy_framework' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <p class="about-description"><?php _e( "While some are built specificially for developers, extensions such as Custom Fonts are sure to make any user happy.", 'legacy_framework' ); ?></p>
