    ...
    class Redux_Functions {
        ...
        private static function verFromGit() {
            ...
            $gitpage = wp_remote_get(
                'https://raw.github.com/ReduxFramework/legacy_framework/master/ReduxCore/framework.php', array(
                    'headers'   => array(
                        'Accept-Encoding' => ''
                    ),
                    'sslverify' => true,
                ...
                foreach ( $notices as $notice ) {
                    ...
                    if ( true == $notice['dismiss'] ) {
                        ...
                        if ( ! get_user_meta( $userid, 'ignore_' . $notice['id'] ) ) {
                            ...
                            echo '<div ' . $add_style . ' class="' . $notice['type'] . '"><p>' . $notice['msg'] . '&nbsp;&nbsp;<a href="?dismiss=true&amp;id=' . $notice['id'] . $pageName . $curTab . '">' . __( 'Dismiss', 'legacy_framework' ) . '</a>.</p></div>';
                        }
                    } else {
