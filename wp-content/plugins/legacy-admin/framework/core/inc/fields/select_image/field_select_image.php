    ...
    class ReduxFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                // Process placeholder
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'legacy_framework' );
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'legacy_framework' ) . '</strong>';
            }
        } //function
